				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ route('home') }}"><img src="{{URL::asset('assets/img/brand/logo.svg')}}" class="logo-1" alt="logo"></a>
							<a href="{{ route('home') }}"><img src="{{URL::asset('assets/img/brand/logo.svg')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ route('home') }}"><img src="{{URL::asset('assets/img/brand/favicon.svg')}}" class="logo-2" alt="logo"></a>
							<a href="{{ route('home') }}"><img src="{{URL::asset('assets/img/brand/favicon.svg')}}" class="dark-logo-2" alt="logo"></a>
						</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								@if (Auth::user()->picture)
									<a class="profile-user d-flex" href=""><img src="{{ URL::asset(Auth::user()->picture) }}" class=""></a>
								@else
									<a class="profile-user d-flex" href=""><img src="{{ URL::asset('uploads/person.jpg') }}" class=""></a>
								@endif
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user">
												@if (Auth::user()->picture)
													<img src="{{ URL::asset(Auth::user()->picture) }}" class=""></span>
												@else
													<img src="{{ URL::asset('uploads/person.jpg') }}" class=""></span>
												@endif
											</div>
									...
									<a class="dropdown-item" href="{{ route('profile') }}"><i class="bx bx-user-circle"></i>الصفحة الشخصية</a>
