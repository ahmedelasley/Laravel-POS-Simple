...
<div wire:ignore.self class="modal fade" id="updateModal" >
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">تعديل بيانات القسم</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button" wire:click="close()"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form id="form" >
        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    >
                        <label for="picture" class="d-block">صورة القسم</label>
                        ...
                        @elseif ($this->picture == NULL)
                            <img src="{{ URL::asset('mahrousa/public/uploads/category.jpg') }}" class="mx-auto my-1 img-thumbnail rounded h-70 w-70" alt="Avatar">
                        @endif
